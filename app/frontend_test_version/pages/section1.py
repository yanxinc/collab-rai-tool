...
st.session_state[f'us1_des'] = st.text_area(":lower_left_ballpoint_pen: **Instruction:** Please describe 1 primary use case of your system that involves some notion of AI usage. The following sections will be completed based on your user story.", value=st.session_state.get(f"us1_des", ""))
