...
direct_stakeholder_def = "<ins>Direct stakeholders</ins> include people who interact with the system directly. They can be system owners, primary users, secondary users, decision subjects or data subjects and malicious actors."
indirect_stakeholder_def = "<ins>Indirect stakeholders</ins> are affected by the system but, unlike direct stakeholders, do not engage with the system itself. Indirect stakeholders can include bystanders, people responsible for decision subjects or data subjects (such as parents), society at large, or communities who may be affected by the system but don't use it."
